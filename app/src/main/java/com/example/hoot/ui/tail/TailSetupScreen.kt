...
@Composable
private fun HabitMappingSection(
...
private fun ConnectedSection(
    config: com.example.hoot.data.local.entity.TailAppConfigEntity?,
...
private fun mealLogsNeverAvailable(state: TailSyncState, lastMealSyncAt: Long?): Boolean {
